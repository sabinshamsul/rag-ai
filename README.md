...
| **Filter junk segments before joining metadata** | Removing non-operative and not-AI-related segments improves retrieval precision and filtering before the join keeps the pipeline cleaner. |
